...
class MoviesFavoritePage extends StatefulWidget {
  final JsonData jsonData;

  const MoviesFavoritePage({Key key, this.jsonData}) : super(key: key);

  @override
  _MoviesFavoritePageState createState() => _MoviesFavoritePageState();
}

class _MoviesFavoritePageState extends State<MoviesFavoritePage> {
  MoviesFavoriteBloc bloc;
  ...
  void initState() {
    super.initState();
    bloc = Modular.get<MoviesFavoriteBloc>();
