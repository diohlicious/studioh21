...
class MoviesFavoriteBloc extends Disposable{
  final MenuRepository moviesRepository;

  MoviesFavoriteBloc(this.moviesRepository);
  ...
  Future fetchMovies() async {
    ...
    movieList=[];
    index = 1;
    var _movies = await moviesRepository.fetchFavMovies(index, json.sort, json.id, json.sessionId);
